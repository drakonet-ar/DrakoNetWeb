document.addEventListener('DOMContentLoaded', () => {
    ...
    // Declare currentColor as a global variable
    let currentColor;
    ...
    function updateShadow(color) {
       ...
       /* const linkhome = document.getElementById('home');
        ...
        const containerInfo3 = document.getElementById('container-info3');
                    ...
                    if (containerInfo1.classList.contains('left')&&containerInfo2.classList.contains('right')){ 
                        linkcontact.classList.add('active');
                        linkabout.classList.add('active');
                        linkhome.classList.remove('active');
                        linknewsletter.classList.remove('active');
                    }
                    //  En este caso si esta Nosotros
                    if(containerInfo1.classList.contains('left')&&!containerInfo2.classList.contains('right')){
                            linkabout.classList.add('active');
                    ...
                    //  En este caso si esta Contacto
                    if(containerInfo2.classList.contains('right')&&!containerInfo1.classList.contains('left')){
                                linkcontact.classList.add('active');
                                linkabout.classList.remove('active');
                                linkhome.classList.remove('active');
                                linknewsletter.classList.remove('active');
                            }
                    // En este caso el que esta actio es Newsletter
                    if(containerInfo3.classList.contains('center')){
                                    linknewsletter.classList.add('active');
                                    linkabout.classList.remove('active');
                                    linkhome.classList.remove('active');
                                    linkcontact.classList.remove('active');
                                }
                    //En este caso no hay ninguno de los links abiertos
                    if(!containerInfo2.classList.contains('right')&&!containerInfo1.classList.contains('left')&&!containerInfo3.classList.contains('center')){
...
*/
    ...
    function animate() {
        ...
        // Update the global currentColor variable
